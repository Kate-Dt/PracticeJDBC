...
import data.worker.WorkWithStudents;
import data.worker.WorkWithTeacher;
...
public class App{
    public static void main( String[] args ){
        ...
        WorkWithStudents worker = (WorkWithStudents) context.getBean("data/worker");
//        new WorkWithStudents();
//        Student testStudent = new Student("Vlad Valt", 5);
//        data.worker.saveStudentToDb(testStudent);
