...
public class JdbcStudentsDao implements StudentsDao {
    ...
    private static final String SQL_INSERT_STUDENT = "insert" +
            " into student (pib,course) values(?,?)";
    private static final String SQL_SELECT_STUDENT_BY_ID = "select " +
            "id, pib, course from student where id = ?";
